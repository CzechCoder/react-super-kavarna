...
const allCategories = ["vše", ...new Set(items.map((item) => item.category))];
      ...
      <nav className="top-menu">
        ...
        <div className="top-menu-wrapper">
          ...
          <div className="menu-items">
            ...
            <a class="menu-menu-item" onClick={() => goTo('MenuMenu')}>Menu</a>
            <a class="menu-menu-item item-padding" onClick={() => goTo('ContactContact')}>Kontakt</a>
            </div>
          </div>
        </div>
        </section>
...
<div className="intro">
      ...
      <section className="contact section" ref={refs.ContactContact}>
        <div className="contact-grid">
          <div className="contact-pic"><img className="contact-img" src="./images/contact.jpg"/></div>
